...
parser.add_argument('--data', metavar='DIR',default='/home/st2/Model_Compression/SRe2L-main/recover/syn_data/cifar100/rn18_bn0.01_[1K]_x_l2_x_tv_sampre0.2.crop',
...
parser.add_argument('--input-size', default=32, type=int, metavar='S',
                    help='argument in RandomResizedCrop')
parser.add_argument("--min-scale-crops", type=float, default=0.4,
                    help="argument in RandomResizedCrop")
parser.add_argument("--max-scale-crops", type=float, default=1.,
                    help="argument in RandomResizedCrop")
parser.add_argument('--fkd-path', default='/home/st2/Model_Compression/SRe2L-main/relabel/CIFAR100_FKD_cutmix_fp16_sampre0.2',
                    type=str, help='path to save soft labels')
parser.add_argument('--use-fp16', dest='use_fp16', action='store_true',
                    help='save soft labels as `fp16`',default=True)
