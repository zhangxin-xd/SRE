...
def get_args():
    ...
    parser.add_argument('--train-dir', type=str, default='/home/st2/Model_Compression/SRe2L-main/recover/syn_data/cifar100/rn18_bn0.01_[1K]_x_l2_x_tv_sampre0.2.crop',
                        help='path to training dataset')
    parser.add_argument('--val-dir', type=str,
                        default='/home/st2/Model_Compression', help='path to validation dataset')
    parser.add_argument('--output-dir', type=str,
                        default='/home/st2/Model_Compression/SRe2L-main/validate/save/cifar100/final_rn18_fkd/rn18_[1K]_T20_sampre0.2/', help='path to output dir')
    ...
    parser.add_argument('-lr', '--learning-rate', type=float,
                        default=0.1, help='sgd init learning rate')  # checked
    ...
    parser.add_argument('-T', '--temperature', type=float,
                        default=20, help='temperature for distillation loss')
    parser.add_argument('--fkd-path', type=str,
                        default='/home/st2/Model_Compression/SRe2L-main/relabel/CIFAR100_FKD_cutmix_fp16_sampre0.2/', help='path to fkd label')
    ...
    parser.add_argument('--mix-type', default='cutmix', type=str,
...
def main():
    ...
    val_data = dset.CIFAR100(args.val_dir, train=False, transform = test_transform)
